...
<form action="" method="POST" name="form">
    <table>
        <tr>
            ...
            <td><input type="text" name="nom" value = "<?= $currentUser->getNom(); ?>" placeholder= "<?= $currentUser->getNom(); ?>"></td>
            <td><label>Entreprise: </label></td>
            <td><input type="text" name="entreprise" value = "<?= $currentUser->getEntreprise(); ?>"" placeholder= "<?= $currentUser->getEntreprise(); ?>"</td>
        </tr>
        <tr>
            <td><label>Prénom: </label></td>
            <td><input type="text" name="prenom" value = "<?= $currentUser->getPrenom(); ?>" placeholder= "<?= $currentUser->getPrenom(); ?>"></td>
            <td><label>Téléphone fixe: </label></td>
            <td><input type="number" name="preFix" value = "<?= substr($currentUser->getFix(),0,2); ?>" placeholder= "<?= substr($currentUser->getFix(),0,2); ?>"><input type="number" name="fix" value = "<?= substr($currentUser->getFix(),2,12); ?>" placeholder= "<?= substr($currentUser->getFix(),2,12); ?>""></td>
        </tr>
        <tr>
            <td><label>Date de naissance: </label></td>
            <td><input type="date" name="dateN" value = "<?= $currentUser->getDate(); ?>" placeholder= "<?= $currentUser->getDate(); ?>"></td>
            <td><label>Téléphone portable</label></td>
            <td><input type="number" name="prePor" value = "<?= substr($currentUser->getPor(),0,2); ?>" placeholder= "<?= substr($currentUser->getPor(),0,2); ?>"><input type="number" name="por" value = "<?= substr($currentUser->getPor(),2,12); ?>" placeholder= "<?= substr($currentUser->getPor(),2,12); ?>"></td>
        </tr>
        <tr>
            <td><label>Adresse Mail: </label></td>
            <td><input type="text" name="mail" value = "<?= $currentUser->getMail(); ?>" placeholder= "<?= $currentUser->getMail(); ?>"></td>
        ...
        <tr>
            ...
            <td><input type="text" name="adr_1" value = "<?= $currentUser->getAdresse(); ?>" placeholder= "<?= $currentUser->getAdresse(); ?>"></td>
        </tr>
        <tr>
            <td>none</td>
